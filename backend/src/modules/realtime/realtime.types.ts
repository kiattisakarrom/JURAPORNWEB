...
export const workflowTables = ['TBLWORKFLOWMASTER', 'TBLPACKAGEPRESCRIPTIONS', 'TBLPACKAGEMASTER', 'TBLPACKAGEITEMS', 'TBLHOSPITALQUEUESTEP', 'TBLDISPENSINGCHANNELCLAIMS'];
