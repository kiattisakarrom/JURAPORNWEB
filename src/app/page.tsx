...
import { getCheckingCheckout, getPharmacyQueue } from "@/lib/pharmacy-api";
import { getPatientProfile } from "@/lib/patient-profile-api";
import { getMachineStockCheck } from "@/lib/stock-check-api";
import { cn } from "@/lib/utils";
import type { AlertKind, CheckingCheckoutResponse, PatientProfile, PatientQueueItem, Priority, QueueStage, StockCheckResponse } from "@/types/pharmacy";
...
function CheckingCheckoutPopup({ patient, onClose }: { patient: PatientQueueItem; onClose: () => void }) {
...
function PatientProfilePopup({ patient, onClose }: { patient: PatientQueueItem; onClose: () => void }) {
